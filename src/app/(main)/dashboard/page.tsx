    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:grid-cols-2 lg:grid-cols-4 md:gap-6">
        <KPICard
          ...
          icon={<WalletIcon className="text-primary-foreground"/>}
          ...
          <AlertDialogTrigger asChild>
            <div className="cursor-pointer">
              <KPICard
                ...
                icon={<GaugeIcon className="text-primary-foreground"/>}
        ...
        {user.isNodeOperator && user.nodeUptimePercentage !== undefined && (
          <Link href="/dashboard/node" className="block">
            <KPICard
              ...
              icon={<ServerIcon className="text-primary-foreground"/>}
      ...
      <Tabs value={activeTab as string} onValueChange={setActiveTab} className="w-full">
        <ScrollArea className="w-full whitespace-nowrap">
            <TabsList className="min-w-0 flex-nowrap w-auto sm:w-full sm:grid sm:grid-cols-4 max-w-2xl">
              <TabsTrigger value="overview"><PieChartIcon className="mr-2 h-4 w-4 text-primary" />Overview</TabsTrigger>
              <TabsTrigger value="portfolio"><BarChartIcon className="mr-2 h-4 w-4 text-primary" />Portfolio</TabsTrigger>
              <TabsTrigger value="achievements"><TrophyIcon className="mr-2 h-4 w-4 text-primary" />Achievements</TabsTrigger>
              <TabsTrigger value="analysis"><SettingsIcon className="mr-2 h-4 w-4 text-primary" />Analysis</TabsTrigger>
            </TabsList>
