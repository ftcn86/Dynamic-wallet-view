...
export function UnverifiedPiDetailCard() {
  ...
  const sources: UnverifiedPiSource[] = [
    { key: 'fromReferralTeam', label: 'From Referral Team', icon: <UsersIcon className="h-5 w-5 text-primary" />, value: fromReferralTeam },
    { key: 'fromSecurityCircle', label: 'From Security Circle', icon: <ShieldIcon className="h-5 w-5 text-green-500" />, value: fromSecurityCircle },
    { key: 'fromNodeRewards', label: 'From Node Rewards', icon: <ServerIcon className="h-5 w-5 text-blue-500" />, value: fromNodeRewards },
    { key: 'fromOtherBonuses', label: 'From Other Bonuses', icon: <GiftIcon className="h-5 w-5 text-yellow-500" />, value: fromOtherBonuses },
  ];
    ...
    <Card className={cn("shadow-lg hover:shadow-xl transition-shadow duration-300")}>
      <CardHeader>
        <CardTitle className="font-headline flex items-center">
          <ListTreeIcon className="mr-2 h-6 w-6 text-primary" />
