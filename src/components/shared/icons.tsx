...
export const AlertTriangleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="hsl(var(--destructive))" {...props}>
...
export const ZapIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="hsl(var(--primary))" {...props}>
        <polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2" fill="hsl(var(--primary-foreground))" stroke="hsl(var(--primary))" strokeWidth="1.5"/>
    </svg>
);
...
export const CalendarDaysIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="hsl(var(--primary))" {...props}>
      ...
      <line x1="16" x2="16" y1="2" y2="6" stroke="#fff" strokeWidth="2"/>
      <line x1="8" x2="8" y1="2" y2="6" stroke="#fff" strokeWidth="2"/>
      <line x1="3" x2="21" y1="10" y2="10" stroke="#fff" strokeWidth="2"/>
    </svg>
);
