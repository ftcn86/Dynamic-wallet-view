...
export const FileTextIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" {...props}>
    ...
    <polyline points="14 2 14 8 20 8" stroke="hsl(var(--card-foreground))" strokeWidth="1.5"/>
    <line x1="16" y1="13" x2="8" y2="13" stroke="hsl(var(--card-foreground))" strokeWidth="1.5"/>
    <line x1="16" y1="17" x2="8" y2="17" stroke="hsl(var(--card-foreground))" strokeWidth="1.5"/>
    <line x1="10" y1="9" x2="8" y2="9" stroke="hsl(var(--card-foreground))" strokeWidth="1.5"/>
  </svg>
);
...
export const ShieldCheckIconSolid = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}>
      ...
      <path d="m9 12 2 2 4-4" stroke="hsl(var(--card-foreground))" strokeWidth="2"/>
    </svg>
);
...
export const SendIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" {...props}>
        ...
        <path d="m22 2-11 11" stroke="hsl(var(--primary-foreground))" strokeWidth="1" />
    </svg>
);
...
export const AlertTriangleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="hsl(var(--destructive))" {...props}>
...
export const GaugeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}>
        ...
        <path d="m12 12-4 2" stroke="hsl(var(--primary-foreground))" />
        <path d="M12 14v4" stroke="hsl(var(--primary-foreground))" />
        <path d="M16 12-2 3" stroke="hsl(var(--primary-foreground))" />
    </svg>
);
...
export const GitBranchIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <circle cx="18" cy="6" r="3" fill="currentColor" stroke="currentColor" strokeWidth="1.5"/>
        <circle cx="6" cy="18" r="3" fill="currentColor" stroke="currentColor" strokeWidth="1.5"/>
...
export const BarChartIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M3 3v18h18" />
        <path d="M7 12h4v6H7zm6-4h4v10h-4z" fill="currentColor"/>
    </svg>
);
...
export const TrophyIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M12 15c-3.87 0-7-3.13-7-7V4h14v4c0 3.87-3.13 7-7 7z" fill="currentColor"/>
    </svg>
);
...
export const SettingsIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" {...props}>
        ...
        <circle cx="12" cy="12" r="3" fill="hsl(var(--card-foreground))" />
    </svg>
);
...
export const UserCircleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" {...props}>
        <circle cx="12" cy="12" r="10" />
        <circle cx="12" cy="10" r="3" fill="hsl(var(--card-foreground))" />
        <path d="M7 18.662V19a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2v-.338a4 4 0 0 0-3.12-3.953h-1.76a4 4 0 0 0-3.12 3.953Z" fill="hsl(var(--card-foreground))" />
    </svg>
);
...
export const InfoIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" {...props}>
        <circle cx="12" cy="12" r="10" />
        <line x1="12" y1="16" x2="12" y2="12" stroke="hsl(var(--card-foreground))" strokeWidth="2" />
        <line x1="12" y1="8" x2="12.01" y2="8" stroke="hsl(var(--card-foreground))" strokeWidth="2" />
    </svg>
);
...
export const ArrowUpRightIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="none" stroke="currentColor" {...props}>
...
export const AwardIconYellow = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="hsl(45, 90%, 50%)" {...props}>
        <circle cx="12" cy="8" r="7"/>
        <polyline points="8.21 13.89 7 23 12 17 17 23 15.79 13.88"/>
    </svg>
);
...
export const ServerIconBlue = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="hsl(210, 80%, 60%)" {...props}>
        <rect x="2" y="2" width="20" height="8" rx="2" ry="2" />
        <rect x="2" y="14" width="20" height="8" rx="2" ry="2" />
        <line x1="6" y1="6" x2="6.01" y2="6" stroke="hsl(var(--card-foreground))" strokeWidth="2"/>
        <line x1="6" y1="18" x2="6.01" y2="18" stroke="hsl(var(--card-foreground))" strokeWidth="2"/>
    </svg>
);
...
export const CheckCircleIconSolid = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" {...props}>
      <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/>
      <polyline points="22 4 12 14.01 9 11.01" stroke="hsl(var(--card-foreground))" strokeWidth="2"/>
    </svg>
);
...
export const ClockIconSolid = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" {...props}>
        <circle cx="12" cy="12" r="10" />
        <polyline points="12 6 12 12 16 14" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" />
    </svg>
);
...
export const XCircleIconSolid = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" {...props}>
        <circle cx="12" cy="12" r="10" />
        <line x1="15" y1="9" x2="9" y2="15" stroke="hsl(var(--card-foreground))" strokeWidth="2" />
        <line x1="9" y1="9" x2="15" y2="15" stroke="hsl(var(--card-foreground))" strokeWidth="2" />
    </svg>
);
...
export const CoinsIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" {...props}>
        ...
        <path d="m14 6-3.1 3.1" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" />
        <path d="m6 14 3.1-3.1" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" />
        <path d="M14 14.8V18" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" />
        <path d="M6 10.2V6" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" />
    </svg>
);
...
export const HomeIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" {...props}>
        ...
        <polyline points="9 22 9 12 15 12 15 22" stroke="hsl(var(--card-foreground))" strokeWidth="2" />
    </svg>
);
...
export const HelpCircleIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" {...props}>
        <circle cx="12" cy="12" r="10" />
        <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" fill="none"/>
        <line x1="12" y1="17" x2="12.01" y2="17" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" fill="none"/>
    </svg>
);
...
export const NetworkIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" {...props}>
        ...
        <path d="M9 5.5H15" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" />
        <path d="M5.5 9V15" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" />
        <path d="M9 18.5H15" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" />
        <path d="M18.5 9V15" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" />
    </svg>
);
...
export const GiftIconYellow = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="hsl(45, 90%, 50%)" {...props}>
        <path d="M20 12v10H4V12" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" />
        <path d="M2 7h20v5H2z" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" />
        <path d="M12 22V7" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" />
        <path d="M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7z" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" />
        <path d="M12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z" stroke="hsl(var(--card-foreground))" strokeWidth="1.5" />
    </svg>
);
...
export const ShieldAlertIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" {...props}>
        <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
        <line x1="12" y1="8" x2="12" y2="12" stroke="hsl(var(--card-foreground))" strokeWidth="2" />
        <line x1="12" y1="16" x2="12.01" y2="16" stroke="hsl(var(--card-foreground))" strokeWidth="2" />
    </svg>
);
...
export const TargetIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" {...props}>
        <circle cx="12" cy="12" r="10" />
        <circle cx="12" cy="12" r="6" fill="hsl(var(--card-foreground))"/>
...
export const CalendarDaysIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24" fill="currentColor" {...props}>
      ...
      <line x1="16" x2="16" y1="2" y2="6" stroke="hsl(var(--card-foreground))" strokeWidth="2"/>
      <line x1="8" x2="8" y1="2" y2="6" stroke="hsl(var(--card-foreground))" strokeWidth="2"/>
      <line x1="3" x2="21" y1="10" y2="10" stroke="hsl(var(--card-foreground))" strokeWidth="2"/>
    </svg>
);
