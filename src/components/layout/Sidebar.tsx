...
const NetworkIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" {...props}>
        ...
        <path d="M9 5.5H15" stroke="#fff" strokeWidth="1.5" />
        <path d="M5.5 9V15" stroke="#fff" strokeWidth="1.5" />
        <path d="M9 18.5H15" stroke="#fff" strokeWidth="1.5" />
        <path d="M18.5 9V15" stroke="#fff" strokeWidth="1.5" />
    </svg>
);
    ...
    <RootSidebar>
        <SidebarHeader>
            <Link href="/dashboard" className="flex items-center gap-3">
                <BlocksIcon className="h-8 w-8 text-primary shrink-0" />
                <span className={cn(
        ...
        <SidebarContent>
            <SidebarMenu>
                ...
                <SidebarMenuItem>
                    <SidebarNavLink href="/dashboard" icon={<HomeIcon className="text-primary"/>}>
                        Dashboard
                    </SidebarNavLink>
                </SidebarMenuItem>
                 <SidebarMenuItem>
                    <SidebarNavLink href="/dashboard/team" icon={<UsersIcon className="text-primary"/>}>
                        Security & Team
                    </SidebarNavLink>
                </SidebarMenuItem>
                 <SidebarMenuItem>
                    <SidebarNavLink href="/dashboard/node" icon={<NetworkIcon className="text-primary"/>}>
                        Node Analysis
                    </SidebarNavLink>
                </SidebarMenuItem>
                <SidebarMenuItem>
                    <SidebarNavLink href="/dashboard/transactions" icon={<CoinsIcon className="text-primary"/>}>
                        Transactions
                    </SidebarNavLink>
                </SidebarMenuItem>
                 <SidebarMenuItem>
                    <SidebarNavLink href="/dashboard/donate" icon={<GiftIcon className="text-primary"/>}>
                        Donate
                    </SidebarNavLink>
                </SidebarMenuItem>
                 <SidebarMenuItem>
                    <SidebarNavLink href="/dashboard/settings" icon={<SettingsIcon className="text-primary"/>}>
                        Settings
                    </SidebarNavLink>
                </SidebarMenuItem>
                <SidebarMenuItem>
                 ...
                 <SidebarMenuItem>
                    <SidebarNavLink href="/legal/help" icon={<HelpCircleIcon className="text-primary"/>}>
                        Help Center
                    </SidebarNavLink>
                </SidebarMenuItem>
            </SidebarMenu>
